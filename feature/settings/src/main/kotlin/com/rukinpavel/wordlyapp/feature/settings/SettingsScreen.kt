...
fun SettingsContent(
    ...
    Scaffold(
        ...
        Column(
            ...
            uiState.language?.let { currentLang ->
                LanguageSetting(
                    selectedLanguage = currentLang,
                    onLanguageChange = { onEvent(SettingsUiEvent.OnLanguageChange(it)) },
                )
            }
            ...
            VibrationSetting(
                ...
                onVibrationChange = { onEvent(SettingsUiEvent.OnVibrationChange(it)) },
            )
            ...
            TutorialSetting(
                onRepeatTutorialClick = { onEvent(SettingsUiEvent.OnRepeatTutorialClick) },
            )
